...
class MealsControllerTest < ActionController::TestCase
  ...
  test "should create meal" do
    assert_difference('Meal.count') do
      post :create, meal: { name: @meal.name, notes: @meal.notes, nutritional_string: @meal.nutritional_string }
    end
  ...
  test "should update meal" do
    put :update, id: @meal, meal: { name: @meal.name, notes: @meal.notes, nutritional_string: @meal.nutritional_string }
    assert_redirected_to meal_path(assigns(:meal))
  end
